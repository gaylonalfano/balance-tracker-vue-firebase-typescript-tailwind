...
export default defineComponent({
  ...
  setup(props) {
    ...
    // A: This works just fine except my table doesn't refresh if I click other cards/routes
    // const {
    //   documents: transactions,
    //   error: errorGetCollection,
    ...
    // Q: What if I don't use getCollection but just db?
    ...
    // Q: How could I make the default orderBy('createdAt') in DESC? Need to prob update composable
